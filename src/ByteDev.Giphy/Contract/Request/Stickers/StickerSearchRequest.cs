...
{
    /// <summary>
    /// Represents a sticker search request.
    /// </summary>
    public class StickerSearchRequest : ApiRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:ByteDev.Giphy.Contract.Request.Stickers.StickerSearchRequest" /> class.
        /// </summary>
        ...
        public StickerSearchRequest(string apiKey) : base(apiKey)
        {
        }
