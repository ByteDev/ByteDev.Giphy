...
namespace ByteDev.Giphy.UnitTests.Contract
{
    [TestFixture]
    public class RatingTests
    {
        ...
        {
            Assert.Throws<InvalidOperationException>(() => _ = new Rating((RatingType)999));
        }
        ...
        {
            Assert.Throws<InvalidOperationException>(() => _ = new Rating("not-a-code"));
        }
